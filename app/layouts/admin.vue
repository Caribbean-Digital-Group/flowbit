    ...
    items: [
      {
        ...
        exact: true,
        iconPaths: [
          'M12 21a9 9 0 100-18 9 9 0 000 18zm0-18c2.5 2.5 3.5 5.5 3.5 9s-1 6.5-3.5 9m0-18C9.5 5.5 8.5 8.5 8.5 12s1 6.5 3.5 9M3 12h18'
        ]
      },
      {
        title: 'Páginas',
      ...
      {
        title: 'Categorías',
        to: '/admin/website/blog/categories',
        iconPaths: ['M7 7h.01M3 5a2 2 0 012-2h5.6a2 2 0 011.4.6l8.4 8.4a2 2 0 010 2.8l-5.6 5.6a2 2 0 01-2.8 0L3.6 12A2 2 0 013 10.6V5z']
      },
      {
        title: 'Etiquetas',
        to: '/admin/website/blog/tags',
        iconPaths: ['M7 20l4-16m2 16l4-16M6 9h14M4 15h14']
      },
      {
        title: 'Autores',
        to: '/admin/website/blog/authors',
        iconPaths: ['M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z']
      },
      {
        title: 'Comentarios',
        to: '/admin/website/blog/comments',
        iconPaths: ['M8 10h.01M12 10h.01M16 10h.01M21 12a8 8 0 01-11.6 7.1L4 20l1-4.2A8 8 0 1121 12z']
      },
      {
        title: 'Medios',
        to: '/admin/website/media',
        iconPaths: ['M4 5h16v14H4zM4 15l4-4 4 4 3-3 5 5M15 9h.01']
      },
      {
        title: 'Galerías',
        to: '/admin/website/galleries',
        iconPaths: ['M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z']
      },
      {
        title: 'Mensajes',
        to: '/admin/website/submissions',
        iconPaths: ['M3 8l7.9 5.3a2 2 0 002.2 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z']
      },
      {
        title: 'Redirecciones',
        to: '/admin/website/redirects',
        iconPaths: ['M13 5l7 7-7 7M5 12h15']
      },
    ]
  },
  {
