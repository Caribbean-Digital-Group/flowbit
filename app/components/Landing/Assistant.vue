    ...
    >
      ...
      >
        ...
        <div class="flex-shrink-0 bg-white border-t border-slate-100 p-4">
          ...
          <NuxtLink
            to="/manual"
            class="mt-2 flex items-center justify-center gap-1.5 py-1.5 text-xs font-semibold text-slate-500 hover:text-indigo-600 transition-colors"
          >
          ...
          <p class="mt-1 text-center text-[11px] text-slate-400">Sin tarjeta de crédito · Sin compromisos</p>
        </div>
      </div>
    </Transition>
